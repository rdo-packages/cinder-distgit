...
rm %{buildroot}%{python2_sitelib}/%{pypi_name}/locale/*/LC_*/%{pypi_name}*po
rm %{buildroot}%{python2_sitelib}/%{pypi_name}/locale/*pot || : #pot files are being removed from source git trees
