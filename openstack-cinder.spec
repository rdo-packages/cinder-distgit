...
%changelog
* Tue Dec 13 2022 Tobias Urdin <tobias.urdin@binero.com> 1:19.1.1-2
- Update systemd unit to reduce memory consumption

* Thu Jul 28 2022 RDO <dev@lists.rdoproject.org> 1:19.1.1-1
- Update to 19.1.1
...
* Fri Oct 01 2021 RDO <dev@lists.rdoproject.org> 1:19.0.0-0.2.0rc1
- Update to 19.0.0.0rc2

* Fri Sep 17 2021 RDO <dev@lists.rdoproject.org> 1:19.0.0-0.1.0rc1
- Update to 19.0.0.0rc1

# REMOVEME: error caused by commit https://opendev.org/openstack/cinder/commit/9810c05e743297171c6cf7572658cbd6a19c5a47
