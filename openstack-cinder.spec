...
%exclude %{python2_sitelib}/%{service}/hacking
%exclude %{python2_sitelib}/%{service}/test.py
%exclude %{python2_sitelib}/%{service}/tests

%files -n python-%{service}-tests
%license LICENSE
%{python2_sitelib}/%{service}/hacking
...
%changelog
* Mon Nov 18 2019 Eric Harney <eharney@redhat.com> 1:12.0.10-2
- Exclude tests from service RPM

* Thu Oct 24 2019 RDO <dev@lists.rdoproject.org> 1:12.0.10-1
- Update to 12.0.10

* Fri Oct 04 2019 RDO <dev@lists.rdoproject.org> 1:12.0.9-1
- Update to 12.0.9

* Fri Jul 26 2019 RDO <dev@lists.rdoproject.org> 1:12.0.8-1
- Update to 12.0.8

* Thu May 09 2019 RDO <dev@lists.rdoproject.org> 1:12.0.7-1
- Update to 12.0.7

* Tue Mar 26 2019 RDO <dev@lists.rdoproject.org> 1:12.0.6-1
- Update to 12.0.6

* Tue Jan 29 2019 RDO <dev@lists.rdoproject.org> 1:12.0.5-1
- Update to 12.0.5

* Mon Jun 18 2018 RDO <dev@lists.rdoproject.org> 1:12.0.3-1
- Update to 12.0.3
...
* Tue Apr 24 2018 RDO <dev@lists.rdoproject.org> 1:12.0.1-1
- Update to 12.0.1
