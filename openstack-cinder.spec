...
%global excluded_reqs google-api-python-client tzdata
%endif
...
%changelog
* Wed Feb 04 2026 RDO <dev@lists.rdoproject.org> 1:25.3.1-1
- Update to 25.3.1
...
* Thu Sep 26 2024 RDO <dev@lists.rdoproject.org> 1:25.0.0-0.2.0rc1
