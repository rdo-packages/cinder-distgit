...
%changelog
* Thu Nov 03 2022 RDO <dev@lists.rdoproject.org> 1:18.2.1-1
- Update to 18.2.1

* Mon Mar 07 2022 RDO <dev@lists.rdoproject.org> 1:18.2.0-1
- Update to 18.2.0

* Wed Sep 01 2021 RDO <dev@lists.rdoproject.org> 1:18.1.0-1
- Update to 18.1.0

* Wed Apr 14 2021 RDO <dev@lists.rdoproject.org> 1:18.0.0-1
- Update to 18.0.0

* Thu Apr 08 2021 RDO <dev@lists.rdoproject.org> 1:18.0.0-0.2.0rc1
- Update to 18.0.0.0rc2

* Fri Mar 26 2021 RDO <dev@lists.rdoproject.org> 1:18.0.0-0.1.0rc1
- Update to 18.0.0.0rc1

# REMOVEME: error caused by commit https://opendev.org/openstack/cinder/commit/60a5de1f6df78b04d5b9e8438b506d6651eaefd8
