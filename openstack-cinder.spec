...
%changelog
* Fri Apr 12 2019 RDO <dev@lists.rdoproject.org> 1:11.2.2-1
- Update to 11.2.2

* Tue Mar 26 2019 RDO <dev@lists.rdoproject.org> 1:11.2.1-1
- Update to 11.2.1

* Thu Feb 28 2019 RDO <dev@lists.rdoproject.org> 1:11.2.0-1
- Update to 11.2.0

* Mon Jun 18 2018 RDO <dev@lists.rdoproject.org> 1:11.1.1-1
- Update to 11.1.1

* Tue Jun  5 2018 Alan Bishop <abishop@redhat.com> 1:11.1.0-2
- Do not repeat log messages on stderr

* Sat Feb 10 2018 RDO <dev@lists.rdoproject.org> 1:11.1.0-1
- Update to 11.1.0
